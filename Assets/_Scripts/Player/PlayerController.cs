...
public class PlayerController : MonoBehaviour
{
    ...
    public bool Grounded; // логическая переменная показывающая находимся мы на земле или нет
    ...
    public void Awake()
    {
        ...
        _playerInput.Player.Jump.performed += context => Jump(Grounded); // подписываем метод Jump к событию нажатия на кнопку прыжка
    }
